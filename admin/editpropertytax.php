...
if (strlen($_SESSION['ocasaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql_get_user = "SELECT UserID FROM tblpropertytax WHERE ID=:eid";
        ...
        if ($user_result) {
            ...
            $sql_update = "UPDATE tblpropertytax SET status=:status WHERE ID=:eid";
            ...
            if ($status === 'verified') {
                $title = "Property Tax Application Verified";
                $message = "Your Property Tax application has been verified successfully.";
            } elseif ($status === 'rejected') {
                $title = "Property Tax Application Rejected";
                $message = "Your Property Tax application has been rejected as the submitted documents do not meet the required authenticity and accuracy standards. Please ensure your documents are correct and resubmit them for further processing.";
            }
...
<body>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h5 class="mb-4 text-danger">Check Property Tax Applications</h5>
                            <?php
                            $eid = $_GET['editid'];
    ...
    <div class="card-body">
        ...
        <p><strong>Property Value:</strong> <?php echo htmlentities($row->property_value); ?></p>
    </div>
</div>
...
<div class="card mb-3">
    <div class="card-body">
        ...
        <p><strong>Property Ownership Document:</strong> <a href="../user/folder2/<?php echo $row->File2; ?>" target="_blank" class="text-danger"><strong>View</strong></a></p>
        <p><strong>Property Valuation Document:</strong> <a href="../user/folder3/<?php echo $row->File3; ?>" target="_blank" class="text-danger"><strong>View</strong></a></p>
