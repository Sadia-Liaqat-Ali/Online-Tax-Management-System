...
if (strlen($_SESSION['ocasaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        // Get the updated status and application ID
        $status = $_POST['status'];
        $eid = $_GET['editid'];

        // Fetch UserID related to the application
        $sql_get_user = "SELECT UserID FROM tblincometax WHERE ID=:eid";
        ...
        if ($user_result) {
            ...
            $sql_update = "UPDATE tblincometax SET status=:status WHERE ID=:eid";
            ...
            if ($status === 'verified') {
                $title = "Income Tax Application Verified";
                $message = "Your Income Tax application has been verified successfully.";
            } elseif ($status === 'rejected') {
                $title = "Income Tax Application Rejected";
                $message = "Your Income Tax application has been rejected as the submitted documents do not meet the required authenticity and accuracy standards. Please ensure your documents are correct and resubmit them for further processing.";
            }
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h5 class="mb-4 text-danger">Check Income Tax Application</h5>
                            <?php
                            $eid = $_GET['editid'];
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <p><strong>Income:</strong> <?php echo htmlentities($row->income); ?></p>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-primary">Verify Documents</h5>
                                      ...
                                      <p><strong>View CNIC:</strong> <a href="../user/folder1/<?php echo $row->File1; ?>" target="_blank" class="text-danger"><strong>View</strong></a></p>
                                            <p><strong>Salary Slip:</strong> <a href="../user/folder2/<?php echo $row->File2; ?>" target="_blank" class="text-danger"><strong>View</strong></a></p>
                                            <p><strong>Electricity Bill:</strong> <a href="../user/folder3/<?php echo $row->File3; ?>" target="_blank" class="text-danger"><strong>View</strong></a></p>
                                            <p><strong>Gas Bill:</strong> <a href="../user/folder4/<?php echo $row->File4; ?>" target="_blank" class="text-danger"><strong>View</strong></a></p>
                                </div>
                            </div>
