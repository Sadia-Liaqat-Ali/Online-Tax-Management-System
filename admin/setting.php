...
$sql ="SELECT ID FROM tbladmin WHERE ID=:uid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tbladmin set Password=:newpassword where ID=:uid";
...
<html lang="en">
<head>
    <title>Online Tax Management System || Profile</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4 text-danger">Change Password</h4>
