...
$sql="update tblincometax set file3=:file3 where ID=:eid";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4 text-danger">Update Note File Third</h4>
...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Upload New Electricity Bill</label>
