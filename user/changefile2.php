...
$sql="update tblincometax set File2=:file2 where ID=:eid";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4 text-danger">Update Note File Second</h4>
...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Upload New Salary Slip</label>
