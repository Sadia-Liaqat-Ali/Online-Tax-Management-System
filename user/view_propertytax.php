...
<html lang="en">
<head>
    <title>OTMS || View Property Tax Application</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h4 class="mb-4 text-danger">Check Property Tax Application</h4>
                            <?php
                            $eid = $_GET['editid'];
                                ...
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            ...
                                            <p><strong>Property Type:</strong> <?php echo htmlentities($row->property_type); ?></p>
                                            <p><strong>Market Value:</strong> <?php echo htmlentities($row->market_value); ?></p>
                                        </div>
                                    </div>
                                </div>
