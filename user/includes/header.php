...
<nav class="navbar navbar-expand sticky-top px-4 py-0" style="background-color: #050A44">
    ...
    <!-- Logo or Title Section (space between sidebar toggle and text) -->
    ...
    <div class="navbar-nav align-items-center ms-auto">
        <!-- New "View Current Tax Rates" item with icon -->
        <div class="nav-item">
            <a href="view_rates.php" class="nav-link fw-bold text-light"><i class="fas fa-percent text-dark"></i>
        ...
        <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                ...
                ?>
                <span class="d-none d-lg-inline-flex text-warning">My Account</span>
                <?php $cnt = $cnt + 1; }} ?>
            </a>
            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                <a href="profile.php" class="dropdown-item">Update Account</a>
